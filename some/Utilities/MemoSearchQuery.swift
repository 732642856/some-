...
enum MemoSearchQueryParser {
    ...
    private static func contentFilter(from value: String) -> MemoContentFilter? {
        ...
        case "web", "webclip", "web-clip", "article", "articles", "网页", "网页摘录":
            return .webClip
        case "web-key-info", "web-keyinfo", "webkeyinfo", "web-info", "web-important-info", "page-key-info", "网页关键信息", "网页关键信息候选", "网页关键候选", "网页关键摘录":
            return .webKeyInfo
        ...
        case "ocr-layout", "ocrlayout", "layout-ocr", "ocr-layout-section", "ocr-layout-sections", "layout-section", "layout-sections", "版面分区", "ocr版面", "图片版面", "识别版面", "分区摘要":
            return .ocrLayout
        case "ocr-key-info", "ocr-keyinfo", "ocrkeyinfo", "key-info-ocr", "ocr-key", "ocr-info", "key-info", "keyinfo", "key-information", "important-info", "关键信息", "关键信息候选", "关键候选", "信息候选", "关键摘录", "ocr关键信息", "图片关键信息", "识别关键信息":
            return .ocrKeyInfo
        ...
        case "ocr-table", "ocrtable", "table-ocr", "ocr-table-candidate", "table-candidate", "table-candidates", "表格候选", "ocr表格", "图片表格", "识别表格":
            return .ocrTable
        case "receipt-lines", "receipt-line", "receiptline", "receipt-line-candidate", "receipt-lines-candidate", "receipt-candidate", "receipt-items", "receipt-item", "票据行", "票据行候选", "小票行", "小票金额", "金额行":
            return .receiptLines
