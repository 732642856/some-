...
当前代码仍处在“随记/素材库底座”阶段：已经完成文字记录、标签、搜索、附件、拍照/拍视频/相册/文件导入、录音 v1、本地语音转写 v1、视频缩略图缓存与媒体元数据摘要 v1、网页摘录 v2、图片/截图 OCR v1、素材索引、素材库视图、手帐页面与画布编辑 v4、工作日志 v1、图片编辑 v3、电子衣橱与穿着洞察 v4、分享扩展、引用、备份、隐私锁和可选 AI 洞察；完整人物/物体抠图、真实天气 API、行程天数和洗护本地通知等仍在路线图中。
...
- 图片编辑 v3：素材库图片可打开编辑器，支持预设比例裁剪、裁剪中心/缩放微调、背景柔化/纯色画布、用户拥有或获授权图片的瑕疵清理贴片、滤镜、边框、文字和贴纸，保存为新的本地 PNG 附件与“图片编辑”素材
