...
当前代码仍处在“随记/素材库底座”阶段：已经完成文字记录、标签、搜索、附件、拍照/拍视频/相册/文件导入、录音 v1、本地语音转写 v1、视频缩略图 v1、网页摘录 v1、图片/截图 OCR v1、素材索引、素材库视图、手帐页面与画布编辑 v1、工作日志 v1、图片编辑 v1、电子衣橱 v1、分享扩展、引用、备份、隐私锁和可选 AI 洞察；自由裁剪、抠图、完整衣橱统计与推荐等仍在路线图中。
